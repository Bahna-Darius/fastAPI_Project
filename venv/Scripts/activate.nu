...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Darius\PycharmProjects\fastApiProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Darius\PycharmProjects\fastApiProject\venv\Scripts\deactivate.nu'
